...
- ** [AWS SES](https://aws.amazon.com/ses/)** - Send emails with AWS SES
- ** [AWS SNS](https://aws.amazon.com/sns/)** - Send SMS with AWS SNS
- ** [NextAuth](https://next-auth.js.org/)** - Authentication with NextAuth

## Table of Contents

- [Next.js Enterprise Boilerplate - With Authentication ](#nextjs-enterprise-boilerplate---with-authentication-)
  - [Features](#features)
...
git clone https://github.com/Dinuda/next-auth-v5.git my-project
```
